...
anaconda]]), and [[https://github.com/tdhock/cs499-599-fall-2022/blob/main/installation.org][emacs]], in which you can see the code, send lines
...
must come to office hours and show me that you can do interactive
code execution)

- Aug 28: [[file:homeworks/01_python.org][Homework week 1: getting started with python]].
...
- Dec 4: reading week, [[file:exams.org][exam review (questions 4-10)]] TODO DATE,
  ...
  score.
- Dec 11: finals week, exam TODO DATE.
